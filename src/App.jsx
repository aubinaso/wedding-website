...
const axelStoryParagraphs = [
  ...
  "Je pense que la première fois qu'Aivi et moi avons vraiment discuté, c'était au Val-de-Saâne. Je ne sais plus par quel concours de circonstances. Peut-être à la suite d'un siège, ou de la Convention européenne. Mais ce dont je me rappelle, c'est qu'elle me disait qu'elle se donne très facilement dans ses relations, qu'elle se livre entièrement, se déverse. Et que cela lui avait souvent créé des problèmes. Je passe les détails.",
  "Ce jour-là, j'avais découvert une fille remplie d'amour, transparente, douce et fragile.",
  "À cette période, je portais le fardeau des FDL (les enseignements pour les dirigeants donnés par le frère Zach). Dans mon zèle de voir les gens y participer, je lui avais écrit pour l'inviter à se connecter.",
